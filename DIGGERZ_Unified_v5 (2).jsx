...
import { realtimeDbReady, saveSurveyResponse, subscribeSurveyResults } from "./src/lib/firebaseSurvey";
...
// ═══ 80 QUESTIONS ═══
const QC=[{t:"Les couleurs sombres me font me sentir en sécurité.",a:{GV:-1,CE:-0.5}},{t:"Je choisis mes couleurs selon MON humeur.",a:{CE:-1,SI:-0.5}},{t:"Le noir est mon bouclier.",a:{PT:-1,CE:-0.5}},{t:"Je porterais du rouge vif devant des inconnus.",a:{CE:1,GV:0.5}},{t:"Les tons bijoux me donnent de l'énergie.",a:{GV:1,SI:0.5}},{t:"Je calcule la couleur que je vais porter.",a:{SI:1,PT:0.5}},{t:"La couleur modifie mon état intérieur.",a:{SI:-1,GV:0.5}},{t:"J'associe les couleurs à des souvenirs tactiles.",a:{SI:-1,GV:-0.5}},{t:"L'or me fait me sentir victorieux(se).",a:{GV:1,CE:0.5}},{t:"Une palette neutre ne me procure pas d'émotion.",a:{CE:-1,GV:-0.5}},{t:"La couleur est un outil d'influence.",a:{SI:1,CE:1}},{t:"Certaines couleurs provoquent une sensation physique.",a:{SI:-1,GV:0.5}},{t:"Les couleurs vives me demandent du courage.",a:{GV:1,CE:0.5}},{t:"Le bleu marine m'évoque le contrôle.",a:{PT:-0.5,GV:-1,SI:0.5}},{t:"Une couleur cachée peut renforcer ma confiance.",a:{CE:-0.5,SI:-1}},{t:"J'ai déjà renoncé à une couleur vive par peur du regard.",a:{CE:-1,PT:-0.5}},{t:"L'améthyste me semble extravagante.",a:{GV:1,SI:-0.5}},{t:"Je choisis mes couleurs à partir de données concrètes.",a:{SI:1,PT:1}},{t:"L'émeraude stimule ma créativité.",a:{GV:0.5,CE:0.5}},{t:"Ma palette parle avant moi.",a:{CE:1,SI:0.5}}];
const QF=[{t:"L'oversize crée un espace protecteur autour du corps.",a:{PT:-1,GV:-0.5}},{t:"Des épaules marquées évoquent la puissance.",a:{PT:0.5,CE:0.5,SI:0.5}},{t:"La superposition est un réflexe naturel chez moi.",a:{PT:-1,GV:0.5,CE:0.5}},{t:"Une coupe ajustée me donne une sensation de contrôle.",a:{SI:0.5,PT:0.5,GV:-0.5}},{t:"L'oversize agit comme une 'soft armor'.",a:{PT:-1,SI:-0.5}},{t:"Je conçois ma silhouette comme un architecte.",a:{SI:1,PT:1}},{t:"La fluidité compte plus que la forme.",a:{SI:-1,GV:0.5}},{t:"Des poches fonctionnelles me rassurent.",a:{PT:1,GV:-0.5}},{t:"Le volume m'apporte de l'espace mental.",a:{SI:-1,PT:-0.5}},{t:"La géométrie transmet un message maîtrisé.",a:{SI:1,CE:1}},{t:"Une coupe trop près du corps me rend anxieux(se).",a:{PT:-1,SI:-0.5}},{t:"Je préfère les lignes nettes aux lignes organiques.",a:{SI:1,PT:1,GV:-0.5}},{t:"La modularité me fascine.",a:{PT:1,SI:1,GV:0.5}},{t:"Le duo corps + vêtement agit comme une protection.",a:{PT:-1,SI:-0.5}},{t:"Le 'More is More' est une vraie philosophie pour moi.",a:{GV:1,CE:1}},{t:"La réversibilité me donne plus d'options utiles.",a:{SI:1,PT:1,CE:0.5}},{t:"Ma silhouette change selon mon humeur.",a:{SI:-1,GV:0.5}},{t:"Je privilégie l'ergonomie invisible à la forme pure.",a:{CE:-1,PT:0.5}},{t:"Les proportions exagérées m'attirent.",a:{GV:1,CE:0.5}},{t:"La forme communique une fonction sociale.",a:{CE:1,SI:1}}];
const QM=[{t:"Une douceur extrême apaise mon système nerveux.",a:{SI:-1,GV:-0.5}},{t:"Un tissu lourd me procure un sentiment de sécurité.",a:{SI:-1,PT:-1}},{t:"Un vêtement lesté peut réduire mon anxiété.",a:{PT:-1,GV:-0.5}},{t:"Une rugosité naturelle m'éveille.",a:{SI:-1,PT:0.5}},{t:"La soie lourde évoque l'autorité.",a:{CE:0.5,SI:0.5,GV:0.5}},{t:"Je juge d'abord un vêtement par le toucher.",a:{SI:-1,CE:-0.5}},{t:"Les matières synthétiques me gênent physiquement.",a:{SI:-1,PT:-0.5}},{t:"Le velours ressemble à une caresse émotionnelle.",a:{SI:-1,PT:-0.5}},{t:"Je choisis selon les propriétés techniques des matières.",a:{SI:1,PT:1}},{t:"La moquette ou le duvet me rappellent une couverture lestée.",a:{PT:-1,SI:-1}},{t:"Les matériaux innovants m'attirent.",a:{PT:1,SI:1,GV:0.5}},{t:"La fausse fourrure m'évoque le luxe Soul Train.",a:{GV:1,CE:1}},{t:"Je préfère les textures complexes aux textures lisses.",a:{GV:1,CE:0.5}},{t:"Le denim brut me donne un ancrage.",a:{GV:-1,PT:-0.5}},{t:"J'analyse la composition avant d'acheter.",a:{SI:1,PT:1}},{t:"La matière influence ma posture.",a:{SI:-1,CE:0.5}},{t:"Le cuir embossé évoque le pouvoir.",a:{CE:0.5,GV:0.5,SI:0.5}},{t:"Le contact textile est non négociable pour moi.",a:{SI:-1,GV:-0.5}},{t:"Le matelassage procure un effet de containment.",a:{PT:-1,SI:-0.5}},{t:"Les matières racontent une histoire technique.",a:{PT:1,CE:1}}];
const QI=[{t:"Les vêtements sont une armure.",a:{PT:-1,CE:-0.5}},{t:"Les vêtements sont une invitation.",a:{CE:1,GV:0.5}},{t:"Mon style reflète qui je suis.",a:{CE:0.5,SI:-0.5}},{t:"J'adapte mon style au contexte.",a:{SI:1,CE:0.5}},{t:"Changer de tenue me soulage.",a:{SI:-1,PT:-0.5}},{t:"Le regard des autres peut me freiner.",a:{CE:-1,PT:-0.5}},{t:"La société influence ma manière de m'habiller.",a:{SI:1,CE:-0.5}},{t:"J'ai trouvé un style optimal pour moi.",a:{CE:0.5,GV:0.5}},{t:"Mon identité vestimentaire est une forme de résistance.",a:{CE:0.5,GV:0.5}},{t:"Je privilégie le fonctionnel au beau.",a:{PT:1,GV:-0.5,CE:-0.5}},{t:"Le luxe fonctionnel me correspond.",a:{PT:0.5,SI:0.5}},{t:"Je me reconnais dans une communauté vestimentaire.",a:{CE:1,GV:0.5}},{t:"L'authenticité est une forme de résistance.",a:{GV:0.5,CE:0.5}},{t:"Je préfère rester discret(e), mais impeccable.",a:{CE:-1,SI:1}},{t:"Le vêtement est une interface cognitive.",a:{SI:0.5,PT:0.5}},{t:"Ma garde-robe est une forme d'intelligence pratique.",a:{SI:1,PT:1,CE:0.5}},{t:"L'overdress est un geste de souveraineté.",a:{CE:1,GV:1}},{t:"La vulnérabilité peut être une force.",a:{CE:1,GV:0.5}},{t:"Je préfère agir silencieusement.",a:{CE:-1,PT:0.5}},{t:"Je peux transformer n'importe quel lieu en Soul Lounge.",a:{CE:1,GV:1,SI:0.5}}];
...
// ═══ TEST ENGINE ═══
function TestEng(){const{setView,setResult,setULv,setUArch,setNotifs}=useContext(Ctx);const[phase,setPhase]=useState("intro");const[ti,setTi]=useState(0);const[qi,setQi]=useState(0);const[ans,setAns]=useState({});const[cur,setCur]=useState(null);const[vis,setVis]=useState(true);
  ...
  const next=()=>{if(cur===null)return;const na={...ans,[`${ti}-${qi}`]:cur};setAns(na);setCur(null);
    if(qi<19)anim(()=>setQi(qi+1));else if(ti<3)anim(()=>{setTi(ti+1);setQi(0);});
      ...
      saveSurveyResponse({archKey:key,scores:nm,answers:na,submittedAt:new Date().toISOString()})
        .then(()=>setNotifs(ns=>[{id:Date.now(),text:"Réponse sync en temps réel",time:0,read:false},...ns].slice(0,12)))
        .catch(()=>{});
      setResult({archKey:key,scores:nm});setULv(2);setUArch(key);setView("results");},2200);}};
...
function ResponsesLive(){const[rows,setRows]=useState([]);const[err,setErr]=useState("");
  useEffect(()=>{const unsub=subscribeSurveyResults(setRows,(e)=>setErr(e?.message||"Realtime subscription error"));return()=>unsub();},[]);
  const fmt=(ts)=>{if(!ts)return"pending";if(typeof ts.toDate==="function")return ts.toDate().toLocaleString("fr-FR");return new Date(ts).toLocaleString("fr-FR");};
  if(!realtimeDbReady)return <div className="fu" style={{minHeight:"100vh",padding:"66px 16px 40px",maxWidth:860,margin:"0 auto"}}><h2 style={{fontFamily:P.mono,fontSize:18,fontWeight:300,color:P.ghost,margin:"0 0 8px"}}>Realtime DB non configurée</h2><p style={{fontFamily:P.mono,fontSize:9,color:P.gray,lineHeight:1.7,marginBottom:10}}>Ajoute tes clés Firebase dans le fichier .env local (voir .env.example), puis redémarre Vite.</p><div style={{border:`1px solid ${P.border}`,padding:10,fontFamily:P.mono,fontSize:8,color:P.textDim,lineHeight:1.7}}>Collection attendue: survey_results<br/>Stockage: archKey, scores, answers, submittedAt, createdAt</div></div>;
  return <div className="fu" style={{minHeight:"100vh",padding:"66px 16px 40px",maxWidth:1000,margin:"0 auto"}}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}><h2 style={{fontFamily:P.mono,fontSize:18,fontWeight:300,color:P.ghost,margin:0}}>Survey Results Realtime</h2><div style={{fontFamily:P.mono,fontSize:7,color:P.emerald}}>LIVE: {rows.length}</div></div>
    {err&&<div style={{border:`1px solid ${P.ruby}55`,padding:8,marginBottom:8,fontFamily:P.mono,fontSize:7,color:P.ruby}}>{err}</div>}
    <div style={{border:`1px solid ${P.border}`}}>
      <div style={{display:"grid",gridTemplateColumns:"120px 120px 1fr 1fr 1fr 1fr 180px",borderBottom:`1px solid ${P.border}`,padding:"6px 8px",fontFamily:P.mono,fontSize:6,color:P.textDim,letterSpacing:"1.5px"}}><span>ID</span><span>ARCHETYPE</span><span>SI</span><span>PT</span><span>GV</span><span>CE</span><span>TIME</span></div>
      <div style={{maxHeight:420,overflowY:"auto"}}>{rows.map(r=><div key={r.id} style={{display:"grid",gridTemplateColumns:"120px 120px 1fr 1fr 1fr 1fr 180px",padding:"6px 8px",borderBottom:`1px solid ${P.border}`,fontFamily:P.mono,fontSize:7,color:P.gray}}><span style={{color:P.textDim}}>{r.id.slice(0,8)}</span><span style={{color:P.ruby}}>{r.archKey||"-"}</span><span>{Math.round(r.scores?.SI||0)}</span><span>{Math.round(r.scores?.PT||0)}</span><span>{Math.round(r.scores?.GV||0)}</span><span>{Math.round(r.scores?.CE||0)}</span><span style={{color:P.textDim}}>{fmt(r.createdAt||r.submittedAt)}</span></div>)}</div>
    </div>
  </div>;}
